...
const PageContent = () => {
  ...
  const { submitPageContent } = usePageContent();
  ...
  // const pageContents = currentPage?.pageContents;
      ...
      <div className={`flex flex-col flex-grow mt-28 min-h-screen`}>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="">
            <div
              className={`${containerNoFlexPaddingStyles} space-y-6 min-h-screen relative bottom-20`}
            >
              <FormField
            ...
            <div
              className={`flex mt-4 w-full fixed justify-center items-center bottom-0 z-40 h-20 shadow2xl  px-4`}
            >
